...
namespace AlgorArt.Controllers
{
    public class RequestFundsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.RequestFunds.Where(x => x.User.Id == username.Id).ToListAsync());
        ...
        public async Task<IActionResult> Create([Bind("Id,FundTitle,FundType,FundDescription,AmountNeeded,AmountRaised,Created")] RequestFunds requestFunds)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FundTitle,FundType,FundDescription,AmountNeeded,AmountRaised,Created")] RequestFunds requestFunds)
        {
